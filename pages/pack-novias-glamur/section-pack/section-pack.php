...
<section class="section-pack md:bg-[url(https://i.postimg.cc/FFjBNkmK/bodas.png)]">
  <figure>
    <img class="w-full md:hidden" src="https://i.postimg.cc/3JYbRrJF/bodas-Mobile.png" alt="Maquillaje">
  </figure>
